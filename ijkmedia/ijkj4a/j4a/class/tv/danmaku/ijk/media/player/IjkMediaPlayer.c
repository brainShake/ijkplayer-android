...
/*
 * IjkMediaPlayer.c — jni4android 生成：Java 字段/静态方法 JNI 封装
 * 供 ijkplayer_jni.c 通过 J4AC_IjkMediaPlayer__* 调用；勿手改（改 .j4a 后重新生成）。
...
/* =============================================================================
 * 一、Java 字段：mNativeMediaPlayer / mNativeMediaDataSource / mNativeAndroidIO
 * ============================================================================= */
...
/* =============================================================================
 * 二、静态回调：postEventFromNative / onSelectCodec / onNativeInvoke
 * ============================================================================= */
...
/* =============================================================================
 * 三、类加载：缓存 jclass / jfieldID / jmethodID（进程内一次）
 * ============================================================================= */
