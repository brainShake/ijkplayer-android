...
/*
 * MediaCodec.c — jni4android 生成：android.media.MediaCodec JNI 封装
 * 硬解节点与 ijksdl_codec_android_mediacodec_java 调用；改 .j4a 后重新生成。
...
/* =============================================================================
 * 二、MediaCodec：create / configure / queue|dequeue / start|stop|flush
 * ============================================================================= */
