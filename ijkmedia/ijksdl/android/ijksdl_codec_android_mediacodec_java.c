/*****************************************************************************
 * ijksdl_codec_android_mediacodec_java.c — Java MediaCodec 的 JNI 封装（configure/queue/dequeue）
 * 供 ffpipenode_android_mediacodec_vdec 硬解节点调用。
 *****************************************************************************
 *
...
/* =============================================================================
 * 一、对象访问与生命周期：getObject / delete / configure / start|stop|flush
 * ============================================================================= */
...
/* =============================================================================
 * 二、输入输出缓冲：writeInputData / dequeueInput|Output、init 工厂
 * ============================================================================= */
