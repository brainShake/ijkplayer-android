/*****************************************************************************
 * ijksdl_android_jni.c — SDL 层 JNI 工具：JVM 保存、子线程 Attach/Detach、异常与引用
 * 所有 native 工作线程在调 Java 前应 SDL_JNI_SetupThreadEnv。
 *****************************************************************************
 *
...
/* =============================================================================
 * 一、JVM 与线程局部 JNIEnv（pthread_key）
 * ============================================================================= */
...
/* =============================================================================
 * 三、设备 API Level 与 JNI_OnLoad（若本文件提供）
 * ============================================================================= */
