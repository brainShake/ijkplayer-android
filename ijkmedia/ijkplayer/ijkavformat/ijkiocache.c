/*
 * ijkiocache.c — 自定义协议 ijkio:cache（边播边缓存、seek 回读本地）
 * 与 inject_callback 统计配合；分段见下文。播放读包经 read_thread → avformat。
 *
...
/* =============================================================================
 * 三、协议 open / read / seek / close（FFmpeg 调用的 IjkURLProtocol）
 * ============================================================================= */
