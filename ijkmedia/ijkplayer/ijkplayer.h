/*
 * ijkplayer.h — 平台无关的 C API（ijkmp_*）与播放器状态机常量
 *
 * 【说明】
 *   - Java JNI 层最终调用这里的 ijkmp_prepare_async / ijkmp_start 等
 *   - MP_STATE_* 描述合法状态迁移，非法调用返回 EIJK_INVALID_STATE
 *   - 实现主要在 ijkplayer.c，播放核心在 ff_ffplay.c
 *
