/*
 * ffpipenode_android_mediacodec_vdec.c — Android MediaCodec 硬解视频管线节点
 * 含 JNI 调用（SDL_AMediaCodec Java 封装）、入队/出队线程；分段见下文「一、二、…」
 *
...
/* =============================================================================
 * 一、Codec 创建与配置：create_codec / configure / reconfigure
 * ============================================================================= */
...
/* =============================================================================
 * 二、缓冲填充与输入：amc_fill_frame、feed_input_buffer(2)
 * ============================================================================= */
...
/* =============================================================================
 * 四、输出排空：drain_output_buffer(2)、排序 AMC_Buf_Out
 * ============================================================================= */
...
/* =============================================================================
 * 五、节点生命周期：destroy / run_sync / flush / config_from_android_mediacodec
 * ============================================================================= */
