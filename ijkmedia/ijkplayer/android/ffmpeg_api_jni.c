/*
 * ffmpeg_api_jni.c — FFmpeg 辅助 API 的 JNI 注册（如 av_base64_encode）
 * 在 ijkplayer_jni.c 的 JNI_OnLoad 中通过 FFmpegApi_global_init 调用。
 *
