/*
 * ff_ffplay.c — 基于 FFmpeg 的播放核心（read/audio/video 线程 + 队列 + 时钟）
 * 分段注释见下文「一、二、…」；架构见 ijkmedia/ARCHITECTURE.md
 *
...
/* =============================================================================
 * 一、PacketQueue / FrameQueue：解复用与解码之间的 packet/frame 缓冲
 * ============================================================================= */
...
/* =============================================================================
 * 二、Decoder / FrameQueue：解码器封装与帧队列
 * ============================================================================= */
...
/* =============================================================================
 * 三、显示与同步：字幕、video_image_display、时钟 master clock
 * ============================================================================= */
...
/* =============================================================================
 * 四、播放线程：audio_thread / video_thread（解码与刷新）
 * ============================================================================= */
...
/* =============================================================================
 * 五、读流线程 read_thread：avformat_open_input、读包入队列
 * ============================================================================= */
...
/* =============================================================================
 * 六、对外 API ffp_*：全局初始化、prepare/start/seek、ijkmp 层直接调用
 * ============================================================================= */
